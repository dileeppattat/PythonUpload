...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F210502786498059" title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F210502786498059" title="oEmbed Form">
<meta property="og:title" content="Incident-form" >
<meta property="og:url" content="https://form.jotform.com/210502786498059" >
<meta property="og:description" content="Please click the link to complete this form." >
<meta name="slack-app-id" content="AHNMASS8M">
<link rel="shortcut icon" href="https://cdn.jotfor.ms/favicon.ico">
<link rel="canonical" href="https://form.jotform.com/210502786498059" />
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=1" />
<meta name="HandheldFriendly" content="true" />
<title>Incident-form</title>
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.23451" />
...
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/payment/payment_styles.css?3.3.23451" />
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
       integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T"
       crossorigin="anonymous">
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/payment/payment_feature.css?3.3.23451" />
...
<script src="https://cdn.jotfor.ms/js/vendor/jquery-1.8.0.min.js?v=3.3.23451" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/vendor/maskedinput.min.js?v=3.3.23451" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/vendor/jquery.maskedinput.min.js?v=3.3.23451" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/static/prototype.forms.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.23451" type="text/javascript"></script>
...
var languageOptions = document.querySelectorAll('#langList li'); 
 for(var langIndex = 0; langIndex < languageOptions.length; langIndex++) { 
   languageOptions[langIndex].on('click', function(e) { setTimeout(function(){ JotForm.setCalendar("6", false, {"days":{"monday":true,"tuesday":true,"wednesday":true,"thursday":true,"friday":true,"saturday":false,"sunday":false},"future":true,"past":true,"custom":false,"ranges":false,"start":"","end":""}); }, 0); });
} 
 JotForm.setCalendar("6", false, {"days":{"monday":true,"tuesday":true,"wednesday":true,"thursday":true,"friday":true,"saturday":false,"sunday":false},"future":true,"past":true,"custom":false,"ranges":false,"start":"","end":""});
...
if (window.JotForm && JotForm.accessible) $('input_7').setAttribute('tabindex',0);
   ...
   JotForm.prepareCalculationsOnTheFly([null,null,null,{"description":"","name":"incidentNumber","qid":"3","subLabel":"","text":"Incident Number","type":"control_textbox"},{"description":"","name":"applicationCode","qid":"4","subLabel":"","text":"Application Code","type":"control_textbox"},{"description":"","name":"priority","qid":"5","subLabel":"","text":"Priority","type":"control_dropdown"},{"description":"","name":"targetDate","qid":"6","text":"Target Date","type":"control_datetime"},{"description":"","name":"comments","qid":"7","subLabel":"","text":"Comments","type":"control_textarea"},{"description":"","name":"jira","qid":"8","subLabel":"","text":"Jira","type":"control_textbox"},null,{"name":"save","qid":"10","text":"Save","type":"control_button"},{"name":"updateIncident","qid":"11","text":"Update Incident","type":"control_head"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,null,null,{"description":"","name":"incidentNumber","qid":"3","subLabel":"","text":"Incident Number","type":"control_textbox"},{"description":"","name":"applicationCode","qid":"4","subLabel":"","text":"Application Code","type":"control_textbox"},{"description":"","name":"priority","qid":"5","subLabel":"","text":"Priority","type":"control_dropdown"},{"description":"","name":"targetDate","qid":"6","text":"Target Date","type":"control_datetime"},{"description":"","name":"comments","qid":"7","subLabel":"","text":"Comments","type":"control_textarea"},{"description":"","name":"jira","qid":"8","subLabel":"","text":"Jira","type":"control_textbox"},null,{"name":"save","qid":"10","text":"Save","type":"control_button"},{"name":"updateIncident","qid":"11","text":"Update Incident","type":"control_head"}]);}, 20); 
</script>
</head>
<body>
<header>
              ...
              <nav class="navbar navbar-expand-md navbar-dark navbar inverse"
                     ...
                     <ul class="navbar-nav">
                           <li><a href="<%=request.getContextPath()%>/list"
                                  class="nav-link">Incidents</a></li>
                     </ul>
                     </nav>
       </header>
  <form class="jotform-form" action="update" method="post" >
  <input type="hidden" name="formID" value="210502786498059" />
  ...
  <div role="main" class="form-all">
    <ul class="form-section page-section">
      <li id="cid_11" class="form-input-wide" data-type="control_head">
        <div class="form-header-group  header-large">
          <div class="header-text httac htvam">
            <h3 id="header_11" class="form-header" data-component="header">
              Update Incident
            </h3>
          </div>
        </div>
      ...
      <li class="form-line" data-type="control_textbox" id="id_3">
        <label class="form-label form-label-right form-label-auto" id="label_3" for="input_3"> Incident Number </label>
        <div id="cid_3" class="form-input" data-layout="half">
          <input type="text" id="input_3" name="incident_number" data-type="input-textbox" class="form-readonly form-textbox" style="width:310px" size="310" value="${incident.incident_number}" tabindex="-1" data-component="textbox" aria-labelledby="label_3" readonly="" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_4">
        <label class="form-label form-label-right form-label-auto" id="label_4" for="input_4"> Application Code </label>
        <div id="cid_4" class="form-input" data-layout="half">
          <input type="text" id="input_4" name="app_code" data-type="input-textbox" class="form-readonly form-textbox" style="width:310px" size="310" value="${incident.app_code}" tabindex="-1" data-component="textbox" aria-labelledby="label_4" readonly="" />
        </div>
      </li>
      <li class="form-line" data-type="control_dropdown" id="id_5">
        <label class="form-label form-label-right form-label-auto" id="label_5" for="input_5"> Priority </label>
        <div id="cid_5" class="form-input" data-layout="half">
          <select class="form-dropdown" id="input_5" name="priority" style="width:310px" data-component="dropdown" aria-labelledby="label_5">
      ...
      <li class="form-line" data-type="control_datetime" id="id_6">
        <label class="form-label form-label-right form-label-auto" id="label_6" for="lite_mode_6"> Target Date </label>
        <div id="cid_6" class="form-input" data-layout="half">
          <div data-wrapper-react="true">
            <div style="display:none">
              <span class="form-sub-label-container" style="vertical-align:top">
                <input type="text" class="form-textbox validate[limitDate]" id="day_6" name="target_date[day]" size="2" data-maxlength="2" data-age="" maxLength="2" value="" autoComplete="off" aria-labelledby="label_6 sublabel_6_day" />
              ...
              <span class="form-sub-label-container" style="vertical-align:top">
                <input type="text" class="form-textbox validate[limitDate]" id="month_6" name="target_date[month]" size="2" data-maxlength="2" data-age="" maxLength="2" value="" autoComplete="off" aria-labelledby="label_6 sublabel_6_month" />
                <span class="date-separate" aria-hidden="true">
                   -
                </span>
              ...
              <span class="form-sub-label-container" style="vertical-align:top">
                <input type="text" class="form-textbox validate[limitDate]" id="year_6" name="target_date[year]" size="4" data-maxlength="4" data-age="" maxLength="4" value="" autoComplete="off" aria-labelledby="label_6 sublabel_6_year" />
                <label class="form-sub-label" for="year_6" id="sublabel_6_year" style="min-height:13px" aria-hidden="false"> Year </label>
              </span>
            </div>
            <span class="form-sub-label-container" style="vertical-align:top">
              <input type="text" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_6" size="12" data-maxlength="12" name="target_date" maxLength="12" data-age="" value="${incident.target_date}" data-format="ddmmyyyy" data-seperator="-" placeholder="dd-mm-yyyy" autoComplete="off" aria-labelledby="label_6" />
              ...
              <label class="form-sub-label is-empty" for="lite_mode_6" id="sublabel_6_litemode" style="min-height:13px" aria-hidden="false">  </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_8">
        <label class="form-label form-label-right form-label-auto" id="label_8" for="input_8"> Jira </label>
        <div id="cid_8" class="form-input" data-layout="half">
          <input type="text" id="input_8" name="jira" data-type="input-textbox" class="form-textbox" style="width:310px" size="310" value="${incident.jira}" data-component="textbox" aria-labelledby="label_8" />
        </div>
      </li>
      <li class="form-line" data-type="control_textarea" id="id_7">
        <label class="form-label form-label-right form-label-auto" id="label_7" for="input_7"> Comments </label>
        <div id="cid_7" class="form-input" data-layout="full">
          <input id="input_7" class="form-textarea" value="${incident.comments}" name="comments" style="width:648px;height:60px" data-component="textarea" aria-labelledby="label_7">
        </div>
      </li>
      <li class="form-line" data-type="control_button" id="id_10">
        <div id="cid_10" class="form-input-wide" data-layout="full">
          <div data-align="right" class="form-buttons-wrapper form-buttons-right   jsTest-button-wrapperField">
            <button id="input_10" type="submit" class="btn btn-success">
              Save
            </button>
          </div>
        </div>
  ...
  <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="210502786498059" />
  <script type="text/javascript">
  var all_spc = document.querySelectorAll("form[id='210502786498059'] .si" + "mple" + "_spc");
for (var i = 0; i < all_spc.length; i++)
{
  all_spc[i].value = "210502786498059-210502786498059";
}
  </script>
...
<script src="https://cdn.jotfor.ms//js/vendor/smoothscroll.min.js?v=3.3.23451"></script>
<script src="https://cdn.jotfor.ms//js/errorNavigation.js?v=3.3.23451"></script>
